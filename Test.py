...
class Application:
    ...
    def player_start_screen(self):
        ...
        self.send_outputln("")
        self.send_outputln("Answer the following \"security\" questions to gain access to this user account.  Each question is worth different values based on difficulty.")
        ...
        self.send_outputln("")
        self.send_outputln("If playing by yourself, answer all questions to gain access and win the game.")
        self.send_outputln("If playing with others, players who score 70 or more will win the game.")
        self.send_outputln("")
